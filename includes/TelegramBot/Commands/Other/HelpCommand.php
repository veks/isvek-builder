...
class HelpCommand extends UserCommand
{
	 ...
	 * @var string
	 */
	protected $description = 'Показать справку по командам бота';
	...
	public function execute(): ServerResponse
	{
		...
		if ($command_str === '') {
			...
			$text .= PHP_EOL . 'Для получения точной справки по команде введите: /help <команда>';
		...
		return $this->replyToChat('Помощь недоступна: Команда `/' . $command_str . '` не найден', ['parse_mode' => 'markdown']);
	}
