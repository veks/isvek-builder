(function () {
	...
	jQuery(document).ready(function ($) {
	  var file_select = function file_select() {
	    var selector_file_select = $('.file-select');
	    if (selector_file_select) {
	      selector_file_select.each(function () {
	        var $this = $(this);
	        var file_select_button = $this.find('.file-select-button');
	        var file_delete_button = $this.find('.file-delete-button');
	        var file_select_input = $this.find('.file-select-input');
	        var wp_media_file_select;
	  ...
	  var image_select = function image_select() {
	    var selector_image_select = $('.image-select');
	    if (selector_image_select) {
	      selector_image_select.each(function () {
	        var $this = $(this);
	        var image_select_button = $this.find('.image-select-button');
	        var image_delete_button = $this.find('.image-delete-button');
	        var image_select_input = $this.find('.image-select-input');
	        var image_container = $this.find('.image-container');
	        var wp_media_image_select;
