...
/***/ "./src/blocks/bootstrap5/components/carousel/components/inspector.js":
/*!***************************************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/components/inspector.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/bootstrap5/components/carousel/edit.js":
/*!***********************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/edit.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_inspector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/inspector */ "./src/blocks/bootstrap5/components/carousel/components/inspector.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/bootstrap5/components/carousel/editor.scss");
...
function Edit(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onSelect: newMedia => {
      const newImages = newMedia.map(img => carouselImages.find(c => c.id === img.id) ? carouselImages.find(c => c.id === img.id) : {
        id: img.id,
    ...
    ...props
  }), carouselImages.length === 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaPlaceholder, {
    onSelect: media => {
      if (media && media[0].id) {
        setAttributes({
          carouselImages: media.map(img => ({
            id: img.id,
            sizes: img.media_details && img.media_details.sizes.full.source_url ? {
              url: img.media_details.sizes.full.source_url
            } : img.sizes.full,
            caption: img.caption || '',
            description: '',
            url: ''
    ...
    allowedTypes: ['image'],
    multiple: true
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }, carouselImages.map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_6__["default"].Item, {
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    className: "d-block img-fluid w-100",
    src: item.sizes.url
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_6__["default"].Caption, null, carouselCaption && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    tagName: "h3",
    allowedFormats: [],
    ...
    onChange: caption => {
      setAttributes({
        carouselImages: [...carouselImages.slice(0, index), Object.assign(carouselImages[index], {
          caption
        }), ...carouselImages.slice(index + 1)]
      });
    }
  }), carouselCaption && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    tagName: "p",
    allowedFormats: [],
  ...
  }), carouselUrl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.URLInput, {
...
/***/ "./src/blocks/bootstrap5/components/carousel/save.js":
/*!***********************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/save.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Save(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, `[isvek-contact-forms id='${id}']`);
}
...
/***/ "./src/blocks/bootstrap5/components/carousel/editor.scss":
/*!***************************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/editor.scss ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/bootstrap5/components/carousel/block.json":
/*!**************************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/block.json ***!
  \**************************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":3,"name":"isvek-plugin-blocks/carousel","version":"1.0.0","title":"Слайдер","icon":"slides","category":"isvek-plugin-blocks","attributes":{"blockId":{"type":"string","default":""},"carouselImages":{"type":"array","default":[]},"carouselVariantDark":{"type":"boolean","default":false},"carouselInterval":{"type":"number","default":5},"carouselCaption":{"type":"boolean","default":true},"carouselIndicators":{"type":"boolean","default":true},"carouselControls":{"type":"boolean","default":true},"carouselFade":{"type":"boolean","default":false},"carouselWrap":{"type":"boolean","default":false},"carouselUrl":{"type":"boolean","default":false},"carouselPause":{"type":"boolean","default":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
"use strict";
/*!************************************************************!*\
  !*** ./src/blocks/bootstrap5/components/carousel/index.js ***!
  \************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/bootstrap5/components/carousel/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/bootstrap5/components/carousel/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/bootstrap5/components/carousel/save.js");
